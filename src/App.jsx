      ...
      <main className="relative mt-28">
        ...
        <section>
          <div className="container m-auto px-4 pt-12 pb-12 sm:pt-20 flex flex-col sm:flex-row gap-6 text-center sm:text-left">
            <div>
              <h2 className="font-bold text-4xl">Hi!, I'm Rutvik Yamkanmardi,</h2>
              <div>
              ...
              <div>
                <p className="mt-4 text-gray-400 text-jusitfy">
                  Passionate Backend Developer transitioning to Data Science,
                  driven by a relentless curiosity and love for problem solving. 
                  Decicated to leveraging strong collaboration and communication 
                  skills to excel in the world of data-driven insights
                </p>
                <button 
                  onClick={() => {
          ...
          <div className="container m-auto px-4">
            ...
            <div className="mt-12 relative before:absolute before:top-0 before:left-16 before:rounded-full before:bottom-10 sm:before:bottom-2 before:w-1 before:bg-white">
              <div className="pl-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                ...
                <p>
                  <b>California State University, Chico - M.S Computer Science</b><br/>
                  Relevant Coursework:
              ...
              <div className="pl-24 mt-12 relative before:w-4 before:h-2 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0 text-lg font-semibold">2022</h3>
                <p>
                  <b>IndiaMART InterMESH Ltd, Noida - Software Engineer</b>
                  <span className="block ml-5">
                    &#8226; Worked as a part of the Company API Team<br />
                    &#8226; Developed and Maintained a High Volume API (3M+ Requests per day)<br />
                    &#8226; Performed Database and Server Migrations to reduce latency<br />
                  </span>
                </p>
              </div>
              <div className="pl-24 mt-12 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                ...
                <p>
                  <b>Indian Institute of Information Technology, Dharwad - B.Tech Computer Science and Engineering</b><br/>
                  Relevant Coursework:
                  <span className="block ml-5">
                    &#8226; Reinforcement Learning<br />
                    &#8226; Game Theory<br />
                    &#8226; Virtualization and Cloud Computing with AWS<br />
                    &#8226; <br />
                  </span>
